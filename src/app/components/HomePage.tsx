...
export default function HomePage() {
  ...
  return (
    <div className="font-sans grid content-center min-h-screen p-8 pb-20 gap-16 sm:p-20">  
      {openTerminal && (
        <>
      ...
      <main className="relative flex flex-col space-y-4 row-start-2 items-center">
        ...
        <div className="relative flex gap-4 items-center rounded-full border-2 border-solid border-white/40 bg-[#f2f2f2] transition-colors h-10 sm:h-12 px-4 sm:px-5 w-full sm:w-auto md:w-[320px]">
          <input
            type="password"
            name="password"
            placeholder="****ERROR****"
